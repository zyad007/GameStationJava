...
public class Player extends HpRender {
    ...
    public Player() {
        super(new HP(50, 50));
        this.image = new ImageIcon(getClass().getResource("/External/SpaceX/image/plane.png")).getImage();
        this.image_speed = new ImageIcon(getClass().getResource("/External/SpaceX/image/plane_speed.png")).getImage();
